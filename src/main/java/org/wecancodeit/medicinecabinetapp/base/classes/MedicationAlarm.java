...
public class MedicationAlarm {
		...
		private String medicationName;
 	    ...
 	    public MedicationAlarm(long id, int hour, int minute, String medicationName, String dosageAmount, String dosageUnits) {
	        this.id = id;
	        this.hour = hour;
	        this.minute = minute;
	    ...
	    public void setDosageAmount(String doseQuantity) {
	        this.dosageAmount = doseQuantity;
	    }

	    public void setDosageUnits(String doseUnit) {
	        this.dosageUnits = doseUnit;
	    }
